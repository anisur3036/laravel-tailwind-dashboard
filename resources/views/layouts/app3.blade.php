...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-100">
        ...
        <div id="sidebar" class="w-64 -left-[100%] fixed sm:left-0 top-0 bg-gray-600 z-50 transition-[width]">
            <div id="brand" class="-left-[100%] fixed sm:left-0 top-0 flex justify-between h-[90px] py-4 pr-0 pl-4 text-white">
                ...
                <button class="close-btn cursor-pointer mr-2 sm:hidden"><x-icon.close class="text-white"></x-icon.close></button>
            </div>
            <nav id="sidebar-menu" class="mt-24 hover:overflow-y-scroll h-screen">
                <ul>
        ...
        <div id="main-container" class="ml-0 sm:ml-64 transition-[margin-left]">
            <header class="flex justify-between fixed left-0 sm:left-64 bg-white w-full sm:w-[calc(100%-256px)] top-0 z-50 p-1 shadow transition-[left]">
                <p>
                    <label for="menu">
                        <x-icon.menu id="menu" class="hidden sm:inline cursor-pointer"></x-icon.menu>
                    </label>
                    <button class="menu-btn sm:hidden">
